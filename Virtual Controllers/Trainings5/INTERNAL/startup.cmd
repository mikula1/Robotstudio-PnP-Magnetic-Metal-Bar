...
uprobe_init -points 500000 -pretrig_points 450000 -trace_buf_sz 10000000
...
sysdmp_add -name dbgService -show dbgService_sysdmp_show

sysdmp_add -name DBG_CFG -source dbg -save dbgService_save -fileext cfg

sysdmp_add -name SYSDMP_DEFAULT -source sysdmp_default -show sysdmp_default_source_show -save sysdmp_default_source_save
sysdmp_add -name SYSDMP_EXC_DEFAULT -show sysdmp_exc_show -fileext log 

sysdmp_add -name PRINT_SPOOLER -source print_spooler -save print_spooler_save_buffer -fileext log 
sysdmp_add -name UPROBE -class uprobe -fileext log
...
sysdmp_add_logfile -name service_debug_early -move 0 -file "$SYSTEM/service_debug_early.cmd"
#NEXT_STEP
...
sysdmp_add -name WVLOG -source wvlog -start wvLogSysdmpStart -stop wvLogSysdmpStop -save wvLogSysdmpSave -fileext wvr
#NO_WVLOG

ifvc -label NO_ETHCAP
sysdmp_add -name ETHCAP -source ethcap -start ethcap_sysdmp_start -stop ethcap_stop -save ethcap_sysdmp_save
#NO_ETHCAP
...
task -slotname safcycts  -slotid 29 -pri 64 -vwopt 0x1c -stcks 10000 \
-entp safcycts -auto
...
task -slotname logsrvts -slotid 51 -pri 100 -vwopt 0x1c -stcks 50000 \
-entp logsrvts -auto
...
task -slotname rloadts -slotid 45 -pri 105 -vwopt 0x1c -stcks 120000 \
-entp rloadts -auto
...
ifvc -label VIRTIOTS_RUN
## Task is part of virtual commissioning and is only applicable for VC.
goto -label SKIP_VIRTIOTS
## Start virtio task. Forwards IO data to safety controller.
#VIRTIOTS_RUN
is_option_present -id "SAFETYMODULE" -ifnot SKIP_VIRTIOTS
task -slotname virtiots  -slotid 147 -pri 95 -vwopt 0x1c -stcks 30000 \
-entp virtiots -auto -noreg
synchronize -level task
go -level task
#SKIP_VIRTIOTS
...
sysdmp_add -name ALARM_FAILED -show alarm_show_failed -source alarm_failed
# Add IPC to the sysdump
sysdmp_add -name IPC -show ipc_show
# Add elog to the sysdump (dumps elog messages to a text file)
sysdmp_add -name ELOG -class elog -fileext txt
# Add semaphore info to the sysdump
sysdmp_add -name SEMAPHORES -show sysdmp_sem_show
# Add devices info to system dump service
sysdmp_add -name DEVICES -show devices_show
# Add ipm to the sysdump
sysdmp_add -name IPM -show ipm_show_data -source ipm_data
# Add pgm info to system dump service
sysdmp_add -name PGM_RAPID -show rapid_show_pgm -source pgm
# Add pgmrun info to system dump service
sysdmp_add -name PGM_RUN -show rapid_show_pgmrun -source pgmrun 
# Add pgmrun info to system dump service
sysdmp_add -name RAPID_SPY -source pgmrun_spy_circular -start pgmrun_spy_circular_start -stop pgmrun_spy_circular_stop -save pgmrun_spy_circular_save_log -fileext log
# Add pgmexe info to system dump service
sysdmp_add -name PGM_EXE -show rapid_show_pgmexe_all -source pgmexe
# Add operator mode info to system dump service
sysdmp_add -name OPERATORMODE -show operator_mode_show -source operator_mode
# Add master control info to system dump service
sysdmp_add -name MASTER_CONTROL-show master_control_show -source mastership
# Add SystemRead info to system dum service
sysdmp_add -name SYSTEM_READ -show systemread_show -source systemread
# Add robdisp info to system dump service
sysdmp_add -name ROBAPI -source robdisp_show -start robdisp_show_sysdmp_start -stop robdisp_show_sysdmp_stop -save robdisp_show_sysdmp_save -fileext log
# Add bspNetDump info to system dump service
sysdmp_add -name BSPNET -show bspNetDump
# Add mchw_show info to system dump service
sysdmp_add -name MC_HW -show mchw_show
# Add FlexPendant dump info to system dump service
sysdmp_add -name FLEXPENDANT -source fpcmd -save fpcmd_diagnostics -fileext log
# Add EIO to system dump service
sysdmp_add -name IO -source eio_sysdmp -save eio_sysdmp
# Add Bulletin Board info to system dump service
sysdmp_add -name BulletinBoard -show BulletinBoard_show_ex
# Add SysEnergy info to system dump service
sysdmp_add -name SYSENERGY -show sysenergy_show
# Add Semaphore info to system dump service
sysdmp_add -name SEM_ALL -show os_sem_show_all
# Add C++ memory pool info to system dump service
sysdmp_add -name MEMORY_POOL -show RobotWare_Memory_Pool_ShowInfoForAllPoolsInSysDmp
# Add rlcyclic info to the system dump service
sysdmp_add -name CYCLIC_BOOL -show RlcyclicShow -source CyclicBool
# Add rldryrun info to the system dump service
sysdmp_add -name DRY_RUN -show RlDryRunShow -source DryRun
# Add Appweb info to system dump service
sysdmp_add -name APPWEB -class sysdump_appweb -fileext log  
# Add RobotWebsevice info to system dump service
sysdmp_add -name ROBAPI2 -show rws_info_show
# Add robcmd_show_diag info to the system dump service
sysdmp_add -name ROBCMD -show robcmd_show_diag
# Add robesu_show_diag info to the system dump service
sysdmp_add -name ROBESU -show robesu_show_diag
# Add sisma_log_show info to system dump service
sysdmp_add -name SISMA -show sisma_log_show
# Add TraceMemLeak_show info to system dump service
sysdmp_add -name TRACE_MEM_LEAK -source TraceMemLeak -show TraceMemLeak_show -start TraceMemLeak_startFromSysdmp -stop TraceMemLeak_stopFromSysdmp
# Add fpgar11_show_hw info to the system dump service
sysdmp_add -name FPGAR11_SHOW_HW -show fpgar11_show_hw
# Add pf_show info to the system dump service
sysdmp_add -name PF_SHOW -show pf_show
...
synchronize -level task
go -level task
sysdmp_add -name SYSDMP_SHELL -class sysdmp_shell_script
#NEXT_STEP

# Generate sysdump on "refma underrun"
sysdmp_trigger_add -name ELOG_50226 -elog_domain 5 -elog_number 226
# Generate sysdump on "Communication lost with Drive Module"
sysdmp_trigger_add -name ELOG_39520 -elog_domain 3 -elog_number 9520
# Generate sysdump on "Overrun of Receive Feedback task"
sysdmp_trigger_add -name INTERNAL_ELOG_RCV_OVERRUN -elog_internal "Overrun of Receive Feedback task"
# Generate sysdump on "rws rapid init wait timeout"
sysdmp_trigger_add -name INTERNAL_ELOG_RWS_INIT_TIMEOUT -elog_internal "Initialization of rapid_subsc failed" -elog_generate_event 1
# Generate sysdump on "refma command queue timeout"
sysdmp_trigger_add -name ELOG_50235 -elog_domain 5 -elog_number 235
# Generate sysdump on "axc underrun of references"
sysdmp_trigger_add -name ELOG_50430 -elog_domain 5 -elog_number 430
# Generate sysdump on "servo underrun"
sysdmp_trigger_add -name ELOG_50082 -elog_domain 5 -elog_number 82
# Generate sysdump on "servo tool error"
sysdmp_trigger_add -name ELOG_50248 -elog_domain 5 -elog_number 248
# Generate sysdump on "servogun opening error"
sysdmp_trigger_add -name ELOG_50251 -elog_domain 5 -elog_number 251
# Generate sysdump on "In Position timeout"
sysdmp_trigger_add -name ELOG_50308 -elog_domain 5 -elog_number 308
...
sysdmp_add_logfile -name INSTALL -move 0 -file "$INTERNAL/install.log"
sysdmp_add_logfile -name STARTUP -move 0 -file "$INTERNAL/startup.log"
sysdmp_add_logfile -name ESTARTUP -move 0 -file "$INTERNAL/ESTARTUP.LOG"
sysdmp_add_logfile -name SHUTDOWN -move 0 -file "$INTERNAL/SHUTDOWN.LOG"
sysdmp_add_logfile -name PF -move 0 -file "$CTRLROOT/pf_info.log"

# Either the CyclicBrakeCheck*.logs exist or BrakeCheck*.log exist if CBC or BC has been executed
sysdmp_add_logfile -name CBCLOG -move 0 -file "/hd0a/TEMP/CyclicBrakeCheck.log"
sysdmp_add_logfile -name CBCLOG1 -move 0 -file "/hd0a/TEMP/CyclicBrakeCheck_1.log"
sysdmp_add_logfile -name BCLOG -move 0 -file "/hd0a/TEMP/BrakeCheck.log"
sysdmp_add_logfile -name BCLOG1 -move 0 -file "/hd0a/TEMP/BrakeCheck_1.log"
...
sysdmp_add_logfile -name SERVICE_DEBUG -move 0 -file "$SYSTEM/service_debug.cmd"
#NEXT_STEP
